...
class PuisiKontemporer extends StatefulWidget {
  @override
  _PuisiKontemporerState createState() => _PuisiKontemporerState();
}

class _PuisiKontemporerState extends State<PuisiKontemporer> {
  @override
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Text('Puisi Kontemporer',
                                textAlign: TextAlign.center, style: TextStyle(fontSize: heading - 4)),
                          ],
                        ),
                      ),
                    ),
                    ...
                    // loop into content
                    for (var i in puisiKontemporer) DialogCard(dialogText: i.subtitle, text: i.title)
                  ],
                ),
              ),
            ),
